...
CreateDirectory["~/.EMSelfForceCache/"];
...
(CheckpointGenerate3p1[ChristoffelCD[{a,Fra},{-b,-Fra},{-c,-Fra}]][ChristoffelPreComputeFraRuleListPartial]["~/.EMSelfForceCache/ChristoffelPreComputeFraRuleListEMPart.mx"][\
...
(CheckpointGenerate3p1[ChristoffelCD[{a,Fra},{-b,-Fra},{-c,-Fra}],UpAndDownInds->True][ChristoffelPreComputeFraRuleList]["~/.EMSelfForceCache/ChristoffelPreComputeFraRuleListEM.mx"][\
...
(CheckpointGenerate3p1[ChristoffelCD[{a,Ret},{-b,-Ret},{-c,-Ret}]][ChristoffelPreComputeRetRuleListPartial]["~/.EMSelfForceCache/ChristoffelPreComputeRetRuleListEMPart.mx"][\
...
(CheckpointGenerate3p1[ChristoffelCD[{a,Ret},{-b,-Ret},{-c,-Ret}],UpAndDownInds->True][ChristoffelPreComputeRetRuleList]["~/.EMSelfForceCache/ChristoffelPreComputeRetRuleListEM.mx"][\
...
CheckpointGenerate3p1[PDBasis[{a,Fra},{b,Ret},{c,Fra}],UpAndDownInds->True][PDBasisRule1]["~/.EMSelfForceCache/PDBasisRule1.mx"][
				((((#/.{PDBasis[{a_,bas1_},{b_,bas2_},{c_,bas3_}]:>PDTemp[{a,bas1}][(Basis[{b,bas2},{c,bas3}]//Frame31Split)/.RetFrameVectorRules]})
						)//ScalefromTempDerivs)//.fromPDTemp//NoScalar//ExpandAll//BasisCanon[NoScreenNoMetric])&];


CheckpointGenerate3p1[PDBasis[{a,Ret},{b,Ret},{c,Fra}],UpAndDownInds->True][PDBasisRule2]["~/.EMSelfForceCache/PDBasisRule2.mx"][\
...
CheckpointGenerate3p1[PDBasis[{a,Fra},{b,Fra},{c,Ret}],UpAndDownInds->True][PDBasisRule3]["~/.EMSelfForceCache/PDBasisRule3.mx"][\
				((((#/.{PDBasis[{a_,bas1_},{b_,bas2_},{c_,bas3_}]:>PDTemp[{a,bas1}][(Basis[{b,bas2},{c,bas3}]//Frame31Split)//RetCanon//Expand]}))
							//ScalefromTempDerivs)//.fromPDTemp//NoScalar//BasisCanon[NoScreenNoMetric])&];


CheckpointGenerate3p1[PDBasis[{a,Ret},{b,Fra},{c,Ret}],UpAndDownInds->True][PDBasisRule4]["~/.EMSelfForceCache/PDBasisRule4.mx"][\
				((((#/.{PDBasis[{a_,bas1_},{b_,bas2_},{c_,bas3_}]:>PDTemp[{a,bas1}][(Basis[{b,bas2},{c,bas3}]//Frame31Split)//RetCanon//Expand]}))
							//ScalefromTempDerivs)//.fromPDTemp//NoScalar//BasisCanon[NoScreenNoMetric])&];
...
CheckpointGenerate3p1[BasisChristoffel[Fra][{a,Fra},{-b,-Fra},{-c,-Fra}]][BasisChristoffelFraRules]["~/.EMSelfForceCache/BasisChristoffelFra.mx"][\
