...
InnerEoMOrder[(SE|CurrentDens)[inds__] r[]^nn_ Ns[inds2__] expr_]:=100+Abs[Length[{inds2}]-nn] + .01*Length[{inds2}];
InnerEoMOrder[(SE|CurrentDens)[inds__] r[]^nn_ Ns[inds2__]]      :=100+Abs[Length[{inds2}]-nn]+ .01*Length[{inds2}];
InnerEoMOrder[(SE|CurrentDens)[inds__] r[] Ns[inds2__] expr_]    :=100+Abs[Length[{inds2}]-1]+ .01*Length[{inds2}];
InnerEoMOrder[(SE|CurrentDens)[inds__] r[] Ns[inds2__]]          :=100+Abs[Length[{inds2}]-1]+ .01*Length[{inds2}];


InnerEoMOrder[(SE|CurrentDens)[inds__] r[]^nn_ expr_]:=100+nn;
InnerEoMOrder[(SE|CurrentDens)[inds__] r[]^nn_ ]     :=100+nn;
InnerEoMOrder[(SE|CurrentDens)[inds__] r[] expr_]    :=100+1;
InnerEoMOrder[(SE|CurrentDens)[inds__] r[] ]         :=100+1;


InnerEoMOrder[(SE|CurrentDens)[inds__] Ns[inds2__] expr_]:=100+Length[{inds2}]+ .01*Length[{inds2}];
InnerEoMOrder[(SE|CurrentDens)[inds__] Ns[inds2__]]      :=100+Length[{inds2}]+ .01*Length[{inds2}];


InnerEoMOrder[(SE|CurrentDens)[inds__] expr_]:=100;
InnerEoMOrder[(SE|CurrentDens)[inds__]]      :=100;


InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[]^nn_ Ns[inds2__] expr_]:=(o+1)*100+Abs[Length[{inds2}]-nn] + .01*Length[{inds2}];
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[]^nn_ Ns[inds2__]]      :=(o+1)*100+Abs[Length[{inds2}]-nn]+ .01*Length[{inds2}];
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[] Ns[inds2__] expr_]    :=(o+1)*100+Abs[Length[{inds2}]-1]+ .01*Length[{inds2}];
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[] Ns[inds2__]]          :=(o+1)*100+Abs[Length[{inds2}]-1]+ .01*Length[{inds2}];


InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[]^nn_ expr_]:=(o+1)*100+nn;
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[]^nn_ ]     :=(o+1)*100+nn;
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[] expr_]    :=(o+1)*100+1;
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] r[] ]         :=(o+1)*100+1;


InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] Ns[inds2__] expr_]:=(o+1)*100+Length[{inds2}]+ .01*Length[{inds2}];
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] Ns[inds2__]]      :=(o+1)*100+Length[{inds2}]+ .01*Length[{inds2}];


InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__] expr_]:=(o+1)*100;
InnerEoMOrder[(SEpert|CurrentDenspert)[LI[o_],inds__]]      :=(o+1)*100;
...
NZkFraSEConsOrderMomentEoM[1][0][0]//ApplyEoMRules[0]


GenerateSumRulesFromEoM[NZkFraSEConsOrderMomentEoM[1][0][0]]


GenerateSumRulesFromEoM[]
